...
export default function Card({title ,src,text}) {
  return (
    ...
    <div className='shadow-lg mt-12 shadow-eventBg mb-8   border bottom-2 rounded-md  border-eventBg flex flex-col  items-center w-9/12 md:w-full mx-auto md:mx-2 
    transition duration-200 ease-in transform sm:hover:scale-105'>
       ...
       <p className='text-black text-sm   p-4'>{text}</p>
       </div>
